...
START_TEST(s21_floor_1) {
  ck_assert_ldouble_eq_tol(s21_floor(-15.123123123), floor(-15.123123123), S21_EPS);
}
END_TEST

START_TEST(s21_floor_2) {
  ck_assert_ldouble_eq_tol(s21_floor(21.123123123), floor(21.123123123), S21_EPS);
}
END_TEST

START_TEST(s21_floor_3) {
    ck_assert_ldouble_eq(s21_floor(0.1),floor(0.1));
} END_TEST
...
START_TEST(s21_floor_6) {
    ck_assert_ldouble_eq(s21_floor(-0.9),floor(-0.9));
} END_TEST
...
START_TEST(s21_floor_12) {
    ck_assert_ldouble_eq(s21_floor(999999.987987987987), floor(999999.987987987987));
} END_TEST
...
START_TEST (s21_floor_14) {
    ck_assert_ldouble_eq(s21_floor(-1.9),floor(-1.9));
} END_TEST
