...
START_TEST(s21_ceil_1) {
  ck_assert_ldouble_eq(s21_ceil(1.3), ceil(1.3));
}
END_TEST
...
START_TEST(s21_ceil_3) {
    ck_assert_ldouble_eq(s21_ceil(0.1), ceil(0.1));
}
END_TEST
...
START_TEST(s21_ceil_11) {
    ck_assert_ldouble_eq(s21_ceil(-0.7), ceil(-0.7));
}
END_TEST

START_TEST(s21_ceil_12) {
    ck_assert_ldouble_eq(s21_ceil(-1.9), ceil(-1.9));
}
END_TEST

START_TEST(s21_ceil_13) {
    ck_assert_ldouble_eq(s21_ceil(0.9), ceil(0.9));
}
END_TEST
...
START_TEST(s21_ceil_15) {
    ck_assert_ldouble_eq(s21_ceil(9.9), ceil(9.9));
}
END_TEST
