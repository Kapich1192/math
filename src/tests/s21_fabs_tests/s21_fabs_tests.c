...
START_TEST(s21_fabs_5) {
    ck_assert_ldouble_eq(s21_fabs(-9519359135915.53151413431), fabs(-9519359135915.53151413431));
}
END_TEST
...
START_TEST(s21_fabs_13){
    ck_assert_ldouble_eq(s21_fabs(-2456245611.156156156), fabs(-2456245611.156156156));
}
END_TEST
